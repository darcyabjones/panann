...
buildRMLibFromEMBL.pl RepeatMaskerLib.embl > RepeatMasker.lib 2>/dev/null

makeblastdb -dbtype nucl -in RepeatMasker.lib > /dev/null 2>&1
makeblastdb -dbtype prot -in RepeatPeps.lib > /dev/null 2>&1
